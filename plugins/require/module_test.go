...
func TestRequireNativeModule(t *testing.T) {
	...
	RegisterNativeModule("test/m", func(instance any, runtime *js.Runtime, module *js.Object) {
...
func TestRegisterCoreModule(t *testing.T) {
	...
	RegisterCoreModule("coremod", func(instance any, runtime *js.Runtime, module *js.Object) {
		o := module.Get("exports").(*js.Object)
		o.Set("test", func(call js.FunctionCall) js.Value {
			return runtime.ToValue("passed")
		})
	...
	RegisterCoreModule("coremod1", func(instance any, runtime *js.Runtime, module *js.Object) {
		o := module.Get("exports").(*js.Object)
		o.Set("test", func(call js.FunctionCall) js.Value {
	...
	RegisterCoreModule("node:test1", func(instance any, runtime *js.Runtime, module *js.Object) {
		o := module.Get("exports").(*js.Object)
		o.Set("test", func(call js.FunctionCall) js.Value {
	...
	registry.RegisterNativeModule("bob", func(instance any, runtime *js.Runtime, module *js.Object) {
